...
@Component({
  selector: 'app-chef-inbox-notification-page',
  templateUrl: './chef-inbox-notification.page.html',
  styleUrls: ['./chef-inbox-notification.page.scss'],
})
export class ChefInboxNotificationPage implements OnInit {
