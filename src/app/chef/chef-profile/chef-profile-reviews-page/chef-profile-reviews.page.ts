...
@Component({
  selector: 'app-chef-profile-reviews-page',
  templateUrl: './chef-profile-reviews.page.html',
  styleUrls: ['./chef-profile-reviews.page.scss'],
})
export class ChefProfileReviewsPage implements OnInit {
