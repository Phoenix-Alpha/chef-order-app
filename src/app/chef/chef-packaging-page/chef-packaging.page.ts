...
@Component({
  selector: 'app-chef-packaging-page',
  templateUrl: './chef-packaging.page.html',
  styleUrls: ['./chef-packaging.page.scss'],
})
export class ChefPackagingPage implements OnInit {
