...
@Component({
  selector: 'app-chef-order-inprep-detail-page',
  templateUrl: './chef-order-inprep-detail.page.html',
  styleUrls: ['./chef-order-inprep-detail.page.scss'],
})
export class ChefOrderInPrepDetailPage implements OnInit {
  ...
  onConfirmDelivery() {
    this.router.navigate(['/public/chef/order/list/inprep/detail/confirm-delivery']);
  }
}