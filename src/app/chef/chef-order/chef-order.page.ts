...
@Component({
  selector: 'app-chef-order-page',
  templateUrl: './chef-order.page.html',
  styleUrls: ['./chef-order.page.scss'],
})
export class ChefOrderPage implements OnInit, AfterViewInit {
  ...
  onClickInfoButton(event) {
    this.router.navigate(['/public/chef/order/instruction'], { queryParams: { mode: "view-info" } })
  }
