...
export class CognitoUtil {
    ...
    public static _REGION = environment.aws_config.aws_region;

    public static _IDENTITY_POOL_ID = environment.aws_config.aws_cognito_identity_pool_id;
    public static _USER_POOL_ID = environment.aws_config.aws_user_pools_id;
    public static _CLIENT_ID = environment.aws_config.aws_user_pools_web_client_id;
    ...
    getUserPool() {
        if (environment.aws_config.aws_cognito_idp_endpoint) {
            CognitoUtil._POOL_DATA.endpoint = environment.aws_config.aws_cognito_idp_endpoint;
        }
    ...
    buildCognitoCreds(idTokenJwt: string) {
        ...
        if (environment.aws_config.aws_cognito_idp_endpoint) {
            url = environment.aws_config.aws_cognito_idp_endpoint + '/' + CognitoUtil._USER_POOL_ID;
        }
        ...
        if (environment.aws_config.aws_cognito_idp_endpoint) {
            serviceConfigs.endpoint = environment.aws_config.aws_cognito_idp_endpoint;
        }
